...
Job.prototype.schedule = function(spec){
	...
	if(typeof(spec) != undefined){
		...
		if(typeof(spec.repeat) != undefined && spec.repeat != null){

			var tmp = [];
			for (var i = 0; i < 60; i+=spec.repeat) {
				tmp.push(i);
			};
			spec.minute = tmp;
		}
...
*/
function RecurrenceRule(year, month, date, dayOfWeek, hour, minute, second,repeat){
	this.recurs = true;
